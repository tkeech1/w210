...
async def detail_post(request: Request, 
                      ...
                      shortage_indicator: Annotated[str | None, Form()] = None, 
    ...
    if shortage_indicator is not None and shortage_indicator != '':
        where_clauses.append(f" shortage_indicator = ? ")
        params.append(shortage_indicator)
...
async def model(request: Request, id: str | None = None):
